...
export const NEW_YORK_SOURCE_REGISTRY: readonly NewYorkSourceDefinition[] = [
  ...
  sourceDefinition({
    id: 'usfs-recreation-sites-ny',
    workPackage: 'WP-207',
    displayName: 'USFS recreation sites, New York clip',
    owner: 'USDA Forest Service',
    canonicalUrl:
      'https://apps.fs.usda.gov/arcx/rest/services/EDW/EDW_RecInfraRecreationSites_02/MapServer',
    endpoint:
      'https://apps.fs.usda.gov/arcx/rest/services/EDW/EDW_RecInfraRecreationSites_02/MapServer/0',
    adapter: 'arcgis-feature-service',
    family: 'poi',
    sourceCrs: 'service coordinates transformed to EPSG:4326',
    attribution: ['USDA Forest Service Enterprise Data Warehouse'],
    disclaimer: 'Published site status does not replace current local closures or restrictions.',
    requiredFields: ['objectid', 'site_cn', 'site_name', 'site_type', 'edw_last_modify'],
    queryParameters: {
      geometry: '-79.7624,40.4774,-71.7517,45.0159',
      geometryType: 'esriGeometryEnvelope',
      inSR: '4326',
  ...
  sourceDefinition({
    id: 'usfs-mvum-trails-ny',
    workPackage: 'WP-207',
    displayName: 'USFS MVUM trails, New York clip',
    owner: 'USDA Forest Service',
    canonicalUrl: 'https://apps.fs.usda.gov/arcx/rest/services/EDW/EDW_MVUM_02/MapServer',
    endpoint: 'https://apps.fs.usda.gov/arcx/rest/services/EDW/EDW_MVUM_02/MapServer/2',
    adapter: 'arcgis-feature-service',
    family: 'trail',
    sourceCrs: 'EPSG:4269 transformed by service to EPSG:4326',
    attribution: ['USDA Forest Service Motor Vehicle Use Map'],
    disclaimer: 'Vehicle designation and season do not guarantee passability.',
    requiredFields: ['objectid', 'name', 'mvum_symbol_name', 'seasonal', 'trailstatus'],
    queryParameters: {
      geometry: '-79.7624,40.4774,-71.7517,45.0159',
      geometryType: 'esriGeometryEnvelope',
      inSR: '4326',
  ...
  sourceDefinition({
    id: 'blm-managed-lands-ny',
    workPackage: 'WP-206',
    displayName: 'BLM surface-management agency, New York clip',
    ...
    disclaimer: 'Surface-management polygons are not legal title or access documents.',
    requiredFields: [
      'OBJECTID',
      'ADMIN_AGENCY_CODE',
      'ADMIN_UNIT_NAME',
