...
const sources = {
  ...
  LA: [
    ['Louisiana State Parks Boundary File FeatureServer layer 4 (2021 snapshot)', 'https://services6.arcgis.com/1fGAZVgZnPx4zcNH/ArcGIS/rest/services/Fidelis/FeatureServer/4', 'api', 'Best downloadable statewide park-boundary layer located: 27 queryable polygons, data last edited 2021-07-29, hosted outside State Parks, and with no published refresh schedule or redistribution/legal-boundary terms. LDWF also exposes a State Parks MapServer, but its service currently has no layers to query or export. Treat this layer as a useful dated snapshot pending State Parks confirmation.'],
  ...
  OK: [
    ['Oklahoma DOT State Parks KML (52 location placemarks; 2018)', 'https://www.odot.org/maps/state/KML/stateparks.kml', 'download', 'Official ODOT KML is the strongest reusable spatial file located, but it contains points only and its HTTP Last-Modified date is 2018-08-10. OTRD’s current parks page reports 38 parks, so the KML should be treated as a historical locator, not a verified current inventory or boundary dataset. The OTRD 2019 CSV is also only names/addresses. No current OTRD GIS API or bulk export was found; use its live State Parks page for current listings.'],
...
const deepDives = [
  ...
  ['LA', 0, 'The best exportable statewide park geometry located is a 27-polygon ArcGIS layer last edited 2021-07-29, hosted outside State Parks with no published refresh schedule or terms. The LDWF State Parks MapServer is currently empty (no queryable layers), so the 2021 service remains a dated snapshot pending agency confirmation.'],
  ...
  ['OK', 0, 'ODOT’s official KML gives 52 point placemarks but was last modified 2018-08-10; it has no park boundaries. OTRD now reports 38 parks on its current website, so the KML is only a historical locator. The OTRD CSV is names/addresses only and was last updated 2019-10-31; no current bulk GIS/API was found.'],
