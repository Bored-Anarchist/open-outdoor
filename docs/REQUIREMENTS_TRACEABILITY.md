...
| `REQ-NFR-001` | Current launch, query, map, recording durability, activation, storage, memory, and accuracy pass normative budgets; measured energy is deferred | P0 | in-progress | M1 | Quality/accessibility owner | 9, 14, 20 | WP-007, WP-008, WP-009, WP-307, WP-503 | Relevant current budget case IDs (`I`,`P`,`A`) | 2026-08-21 |
| `REQ-ENE-001` | Define and pass representative battery/thermal protocols and numeric endurance limits before production claims | P1 | protocol-defined/conditionally-deferred | M6 | iOS/tracking owner | 14 | WP-307, WP-503 | T-PHY-002 (supplemental at M4; blocking at M6) | 2026-09-02 |
...
| `REQ-IOS-001` | Native background/sensor/map/accessibility/provisioning acceptance uses a physical iPhone; energy acceptance is separately deferred | P0 | in-progress | M1 | iOS/tracking owner | 15, 19 | WP-006, WP-007, WP-109, WP-307, WP-503 | T-PHY-001, T-PHY-003–T-PHY-005; T-PHY-002 reserved | 2026-08-21 |
...
| `REQ-CI-001` | Hosted CI is local-first and must complete a bounded 20-applicable-run window with zero avoidable failures | P0 | in-progress | M1 | Release/build owner | 17, 23 | WP-001, WP-002, WP-006, WP-009 | T-REL-001, T-REL-004 (`A`) | 2026-08-21 |
...
| 2026-08-21 | Implemented WP-007 sequenced native tracking and energy-conscious policy checks, WP-008 protected split-store/catalog activation and compatibility prechecks, and WP-009 Phase 0 gate review | REQ-TRK-002, REQ-TRK-004, REQ-USR-002, REQ-CAT-001, REQ-CAT-004–005, REQ-CAT-007, REQ-CFG-002, REQ-IOS-001–003, REQ-NFR-001, REQ-ENE-001 | Implementation foundation complete; physical-device acceptance remains blocked |
| 2026-08-21 | Deferred measured battery/thermal acceptance from Phase 0/Phase 1 to WP-307/WP-503 and reduced the separate memory smoke to 30 minutes | REQ-TRK-004, REQ-NFR-001, REQ-ENE-001, REQ-IOS-001 | User-approved scope reduction; no endurance claim |
| 2026-08-23 | Implemented durable tracker recovery/readback, synthetic native storage diagnostics, deterministic A-to-B fixtures, read-only iTunes backup inspection, ADR-041 restore deferral, and the 20-run CI ledger | REQ-TRK-001, REQ-USR-002, REQ-CAT-004, REQ-CAT-007, REQ-CFG-002, REQ-IOS-002–003, REQ-CI-001 | Implementation complete; CI window passed 20/20 with zero avoidable failures; physical acceptance remains pending |
...
| 2026-09-09 | Implemented WP-501 original tokens/icons, native components, complete field-state catalog, local appearance styles and automated T-E2E-001-D01–D03 | REQ-UX-001, REQ-MAP-003, REQ-A11Y-001 | Automated evidence recorded separately; physical production acceptance remains gated |
| 2026-09-10 | Implemented WP-502/WP-503 native accessibility settings/announcements, browser audits, foreground/I/O hardening and strict production-quality evidence; deferred physical execution to Phase 5 end by owner instruction | REQ-A11Y-001, REQ-NFR-001, REQ-ENE-001 | ADR-049; automated completion separate from WP-506 physical acceptance |
| 2026-09-10 | Implemented WP-504 detached release signing, external-policy verification, BOM inventory and dependency response; WP-505 actual contributor governance, quorum and support/LTS | REQ-REL-001, REQ-CFG-001, REQ-OSS-001–003; T-REL-002/003, T-SEC-002 | Automated synthetic verification; production audit and physical evidence remain WP-506 gates |
| 2026-09-10 | Implemented WP-506 signed-candidate audit, all 26 acceptance rows, independent review/reproduction policy and public clean-checkout runner | All project acceptance criteria; REQ-REL-001, REQ-OSS-001–003, REQ-A11Y-001, REQ-NFR-001, REQ-ENE-001 | ADR-050: tests/reviews execute after WP-506; production acceptance remains blocked |
| 2026-09-10 | Added coordinated Windows/iOS Phase 5 guided runner, persistent coordinate-free observations and exact-candidate import | REQ-A11Y-001, REQ-NFR-001, REQ-ENE-001, REQ-REL-001 | Automated preflight/validation separate from post-WP-506 physical and independent acceptance |
| 2026-09-12 | Owner accepted the complete automatic Phase 5 preflight on PR #10 candidate `4d829da`; all four guided-runner sections and five hosted checks passed | REQ-A11Y-001, REQ-NFR-001, REQ-ENE-001, REQ-REL-001 | Automatic sign-off only; physical, endurance, independent review/reproduction and production approval remain blocked |
| 2026-09-12 | Retired the in-app Phase 1, Phase 3 and Phase 5 guided runners plus runner-only native bridges after owner sign-off | REQ-UX-001, REQ-REL-001 | Historical reports, gate dispositions and headless validators retained; no acceptance result or outstanding production blocker changed |
