...
| `REQ-CFG-002` | Production supports current plus one previous compatible major app/catalog/backup schema and rejects unsafe downgrade before mutation | P0 | in-progress | M1 | Storage/backup owner | 8, 18, 19 | WP-008, WP-107, WP-303 | T-INT-006, T-BAK-001 | 2026-08-21 |
...
| `REQ-IOS-003` | Private state and regenerable catalogs are excluded from implicit iOS system backup; supported recovery uses explicit encrypted backup | P0 | in-progress | M1 | iOS/tracking owner | 8, 18 | WP-008, WP-107 | T-PHY-005, T-BAK-001 | 2026-08-21 |
