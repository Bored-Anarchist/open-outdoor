...
| `REQ-CAT-006` | Production catalog activation requires a valid channel-bound signature, trusted non-revoked key, and non-replayed version | P0 | proposed | M1 | Release/build owner | 8, 17, 19 | WP-010, WP-303, WP-504 | T-REL-003 (`I`,`A`) | 2026-08-19 |
...
| ID | Requirement | Priority | Status | Milestone | Accountable role | Scope | Work packages | Verification | Changed |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `REQ-PRV-001` | Personal, restricted, secret, and operational-private data never enter public GitHub, CI, or releases | P0 | proposed | M1 | Privacy/rights owner | 6 | WP-003 | T-SEC-002 (`R`,`A`) | 2026-08-19 |
| `REQ-PRV-002` | A Windows private root resolves outside the public checkout and is always explicit | P0 | proposed | M1 | Architecture owner | 6.2 | WP-004 | T-E2E-003 | 2026-08-19 |
| `REQ-PRV-003` | Private downstream sync uses a private repository and never a public fork or public workflow carrying private payloads | P0 | proposed | M1 | Architecture owner | 6.3 | WP-005, WP-405 | T-E2E-003, T-SEC-003 | 2026-08-19 |
| `REQ-PRV-004` | Secrets and signing/recovery keys remain outside Git, including private Git | P0 | proposed | M1 | Security owner | 6, 18, 19 | WP-003, WP-006, WP-107 | T-SEC-002 | 2026-08-19 |
| `REQ-PRV-005` | Removing private extensions leaves a complete passing public build | P0 | proposed | M1 | Architecture owner | 6.4 | WP-004, WP-405 | T-E2E-003 | 2026-08-19 |
...
| `REQ-PRV-007` | Only data whose policy permits indefinite versioned retention may enter private Git; expiring/revocable/deletion-bound data remains external | P0 | proposed | M1 | Privacy/rights owner | 6.3, 18 | WP-003, WP-005 | T-SEC-002, T-SEC-003 | 2026-08-19 |
...
| `REQ-DIA-001` | Diagnostics remain local, bounded, short-lived, redacted, user-previewed, and explicitly exported | P0 | proposed | M1 | Privacy/rights owner | 18 | WP-003 | T-DIA-001 (`I`,`R`) | 2026-08-19 |
...
| `REQ-SEC-002` | Private CI uses ephemeral isolated jobs, no untrusted privileged head execution, separate caches/artifacts, and least-privilege credentials | P0 | proposed | M1 | Security owner | 6.3, 17 | WP-005 | T-SEC-003 (`E`,`R`) | 2026-08-19 |
...
| ID | Requirement | Priority | Status | Milestone | Accountable role | Scope | Work packages | Verification | Changed |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| `REQ-PLT-001` | The initial consumer product ships only on iOS; browser code is a QA harness and Android delivery requires change control | P0 | proposed | M1 | Product owner | 4, 22 | WP-002, WP-006 | T-REL-001, product-boundary audit | 2026-08-19 |
...
| `REQ-DEV-001` | Shared development/build/test works on Windows from pinned public dependencies | P0 | proposed | M1 | Release/build owner | 4, 15, 19 | WP-002 | T-REL-001 | 2026-08-19 |
| `REQ-IOS-001` | Native background/sensor/map/accessibility/provisioning/energy acceptance uses a physical iPhone | P0 | proposed | M1 | iOS/tracking owner | 15, 19 | WP-006, WP-007, WP-109 | T-PHY-001–T-PHY-005 | 2026-08-19 |
| `REQ-CFG-001` | Release configuration pins JS/native/Python/GIS/iOS tools, identity, regions, schemas, trust, and budgets | P0 | proposed | M1 | Release/build owner | 19.1 | WP-002, WP-010, WP-504 | T-REL-001, T-REL-002 | 2026-08-19 |
