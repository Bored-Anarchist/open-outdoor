...
| `REQ-TRK-004` | Provide Balanced, Endurance, and explicit High Accuracy modes with explainable changes | P1 | in-progress | M2 | iOS/tracking owner | 14 | WP-103, WP-105 | T-PHY-002 (`P`) | 2026-08-21 |
...
| `REQ-NFR-001` | Launch, query, map, recording durability, activation, storage, memory, accuracy, and energy pass the normative budgets | P0 | in-progress | M1 | Quality/accessibility owner | 9, 14, 20 | WP-007, WP-008, WP-009, WP-307, WP-503 | Relevant budget case IDs (`I`,`P`,`A`) | 2026-08-21 |
| `REQ-ENE-001` | Energy limits use at least three four-hour physical runs per mode and unexplained thermal/wakeup or greater-than-10% regression blocks release | P0 | in-progress | M2 | iOS/tracking owner | 14 | WP-007, WP-109, WP-307, WP-503 | T-PHY-002 | 2026-08-21 |
...
| `REQ-IOS-001` | Native background/sensor/map/accessibility/provisioning/energy acceptance uses a physical iPhone | P0 | in-progress | M1 | iOS/tracking owner | 15, 19 | WP-006, WP-007, WP-109 | T-PHY-001–T-PHY-005 | 2026-08-21 |
