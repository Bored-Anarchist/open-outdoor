...
| 2026-08-21 | Implemented durable tracker recovery/readback, synthetic native storage diagnostics, deterministic A-to-B fixtures, read-only iTunes backup inspection, ADR-041 restore deferral, and the 20-run CI ledger | REQ-TRK-001, REQ-USR-002, REQ-CAT-004, REQ-CAT-007, REQ-CFG-002, REQ-IOS-002–003, REQ-CI-001 | Implementation complete; physical acceptance and CI-window completion remain pending |
