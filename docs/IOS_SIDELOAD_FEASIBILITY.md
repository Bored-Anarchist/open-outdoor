...
WP-006 is accepted and closed for its feasibility scope. The missing absolute expiry and refresh timestamps remain a recorded evidence-granularity deviation, not fabricated measurements. This closeout does not satisfy WP-008 state-retention, system-backup exclusion, or compatibility acceptance and does not by itself close the Phase 0 gate. Encrypted restore is outside Phase 0 under ADR-041.
