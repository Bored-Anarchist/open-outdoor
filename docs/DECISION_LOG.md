...
| `ADR-048` | Phase 3 conditionally approves field endurance and defers its blocking acceptance to WP-503/Phase 5 | Accepted | Multi-hour battery/thermal runs are supplemental for M4 and cannot support endurance claims; Phase 3 still requires installability, device flows, accessibility, non-endurance performance, stopped-sensor policy, and deterministic reliability tests |
