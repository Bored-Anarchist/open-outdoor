...
| `DOC-013` | Performance, durability, accuracy, memory, and energy gates were subjective | Added numeric current budgets and reference profiles; deferred measured energy acceptance to WP-307/WP-503 with no interim endurance claim | [Non-functional budgets](NON_FUNCTIONAL_BUDGETS.md) |
